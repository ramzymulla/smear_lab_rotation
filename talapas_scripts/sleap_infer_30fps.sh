...
#SBATCH --output=logs/sleap_infer/sleap_infer_30fps_%j.out
#SBATCH --error=logs/sleap_infer/sleap_infer_30fps_%j.err
#SBATCH -t0-24
#SBATCH --gres=gpu:1
...
for vid in $(find $vidRootDir -type f | grep -E "[0-9].avi"); do 
