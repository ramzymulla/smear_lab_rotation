...
#SBATCH --output=logs/kpms_apply_model/kpms_apply_model_%j.out
#SBATCH --error=logs/kpms_apply_model/kpms_apply_model_%j.err
#SBATCH -t0-24
#SBATCH --gres=gpu:1
...
/usr/bin/time -v python /home/rza/Research/smearlab/scripts/smear_lab_rotation/kpms_apply_model.py $framerate $predsDir $includeStr
